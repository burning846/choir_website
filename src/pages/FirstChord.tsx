    ...
    <div className="bg-white dark:bg-neutral-900 rounded-xl shadow-md overflow-hidden border border-gray-100 dark:border-rosegold-900/30 hover:shadow-lg transition-all duration-300">
      ...
      >
        <div className={`transition-all duration-300 ${isExpanded ? 'border-b border-gray-100 dark:border-rosegold-900/30 pb-4 mb-4' : ''}`}>
          ...
          <div className="mt-4 flex justify-end text-gray-400 group-hover:text-rosegold-500 transition-colors">
            {isExpanded ? (
...
export default function FirstChord() {
  ...
  return (
    <div className="min-h-screen bg-paper dark:bg-black transition-colors duration-300 font-sans">
      {/* Navigation Bar */}
      <div className="fixed top-0 left-0 right-0 z-40 bg-paper/80 dark:bg-black/80 backdrop-blur-md border-b border-gray-200 dark:border-rosegold-900/30 transition-colors duration-300">
      ...
      <div className="container mx-auto px-6 py-16 space-y-24 max-w-5xl">
        ...
        <section className="scroll-mt-24">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-rosegold-400 mb-4">{d.intro.title}</h2>
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-3xl shadow-xl p-8 md:p-12 border border-gray-100 dark:border-rosegold-900/30">
        ...
        <section className="scroll-mt-24">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-rosegold-400 mb-4">{d.legacy.title}</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-rosegold-500 to-lightpurple-500 dark:from-rosegold-600 dark:to-rosegold-400 mx-auto rounded-full"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-rosegold-50 to-orange-50 dark:from-neutral-900 dark:to-black rounded-3xl p-8 md:p-10 shadow-lg border border-rosegold-100 dark:border-rosegold-900/50">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-rosegold-100">{d.legacy.subtitle}</h3>
              </div>
            ...
            <div className="bg-gradient-to-br from-lightpurple-50 to-pink-50 dark:from-neutral-900 dark:to-black rounded-3xl p-8 md:p-10 shadow-lg border border-lightpurple-100 dark:border-rosegold-900/50">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-rosegold-100">{d.legacy.visionTitle}</h3>
              </div>
              <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <section className="scroll-mt-24">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-rosegold-400 mb-4">{d.conductors.title}</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-rosegold-500 to-lightpurple-500 dark:from-rosegold-600 dark:to-rosegold-400 mx-auto rounded-full"></div>
          </div>
                ...
                <div className="grid md:grid-cols-3">
                  <div className="bg-gradient-to-br from-lightpurple-100 to-rosegold-100 dark:from-neutral-950 dark:to-black p-8 flex flex-col items-center justify-center h-full space-y-4 border-b md:border-b-0 md:border-r border-transparent dark:border-rosegold-900/50">
                    ...
                    <div className="text-center">
                      <h3 className="text-2xl font-bold text-gray-800 dark:text-rosegold-100">{c.name}</h3>
                      ...
                      <div className="flex flex-col space-y-3 w-full mt-4">
                        {c.experience && (
                          <div className="flex items-center text-sm px-4 py-2 rounded-lg bg-white/50 dark:bg-rosegold-900/20 ring-1 ring-black/5 dark:ring-rosegold-800/30 backdrop-blur-sm text-gray-700 dark:text-rosegold-200 w-full">
                  ...
                  <div className="p-6 md:p-8 space-y-6 border-t md:border-t-0 md:border-l border-gray-200 dark:border-rosegold-900/50 md:col-span-2">
                    <div>
                      <h4 className="text-lg font-semibold text-gray-800 dark:text-rosegold-300 mb-2">{lang === 'en' ? 'Biography' : '个人简介'}</h4>
                      <p className="text-gray-600 dark:text-gray-300 leading-relaxed">{c.bio}</p>
                    </div>
                    {c.highlights && c.highlights.length > 0 && (
                      <div>
                        <h4 className="text-lg font-semibold text-gray-800 dark:text-rosegold-300 mb-2">{lang === 'en' ? 'Highlights' : '重点经历'}</h4>
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-gray-800 dark:text-rosegold-300 mb-2 flex items-center">
                    ...
                    <div className="bg-gradient-to-r from-lightpurple-50 to-rosegold-50 dark:from-rosegold-900/20 dark:to-neutral-900 rounded-lg p-4 md:p-6 dark:border dark:border-rosegold-900/30">
                      <h4 className="text-lg font-semibold text-gray-800 dark:text-rosegold-300 mb-2">{lang === 'en' ? 'Conducting Philosophy' : '指挥理念'}</h4>
                      <p className="text-gray-600 dark:text-rosegold-200/80 italic leading-relaxed">{c.philosophy || (lang === 'en' ? "Music is a universal language; choir connects hearts in harmony." : "音乐是人类共同的语言，合唱是心灵交流的桥梁。我希望通过我们的演唱，让每一个听众都能感受到音乐的力量和美好。")}</p>
                    </div>
                  </div>
                </div>
              </Card>
        ...
        <section className="scroll-mt-24">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-rosegold-400 mb-4">{d.program.title}</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-rosegold-500 to-lightpurple-500 dark:from-rosegold-600 dark:to-rosegold-400 mx-auto rounded-full"></div>
          </div>
        ...
        <section className="scroll-mt-24">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-rosegold-400 mb-4">{d.talents.title}</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-rosegold-500 to-lightpurple-500 dark:from-rosegold-600 dark:to-rosegold-400 mx-auto rounded-full"></div>
          </div>

          <div className="grid sm:grid-cols-2 gap-8">
            {d.talents.sections.map((section, i) => (
              <div key={i} className="bg-white dark:bg-neutral-900 rounded-3xl overflow-hidden shadow-xl border border-gray-100 dark:border-rosegold-900/30 flex flex-col hover:shadow-2xl transition-shadow group">
                {section.imagePrefix && (
                  <div className="w-full aspect-[3/2] overflow-hidden bg-gray-100 dark:bg-neutral-950 relative">
                    <picture>
        ...
        <section className="scroll-mt-24 pb-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-rosegold-400 mb-4">{d.gratitude.title}</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-rosegold-500 to-lightpurple-500 dark:from-rosegold-600 dark:to-rosegold-400 mx-auto rounded-full"></div>
          </div>

          <div className="bg-white dark:bg-neutral-900 rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 dark:border-rosegold-900/30 text-center mb-12">
            <p className="text-xl md:text-2xl text-gray-700 dark:text-rosegold-200/80 leading-relaxed font-light italic mb-10">
            ...
            <div className="grid md:grid-cols-2 gap-12 text-left">
              {/* Acknowledgements */}
              <div className="space-y-6">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-rosegold-100 border-b-2 border-rosegold-500 dark:border-rosegold-700 pb-2 inline-block">{d.gratitude.acknowledgements.title}</h3>
                <div className="space-y-4">
                  <div className="flex flex-col">
                    ...
                    <span className="text-lg font-medium text-gray-900 dark:text-rosegold-200">{d.gratitude.acknowledgements.venue.name}</span>
                  </div>
                  <div className="flex flex-col">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-2">
                    <div className="bg-slate-50 dark:bg-black/50 p-4 rounded-xl dark:border dark:border-rosegold-900/30">
          ...
          {/* Founder's Note */}
          <div className="bg-gradient-to-br from-slate-900 to-rosegold-900 dark:from-neutral-950 dark:to-black dark:border dark:border-rosegold-900/50 rounded-3xl p-8 md:p-12 shadow-2xl text-white relative overflow-hidden">
