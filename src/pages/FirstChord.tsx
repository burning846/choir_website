...
export default function FirstChord() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gray-900 transition-colors duration-300 font-sans">
      ...
      <div className="fixed top-0 left-0 right-0 z-40 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-gray-200 dark:border-slate-800 transition-colors duration-300">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <img src="/logo.svg" alt="Konzert Singers Logo" className="h-8 w-auto object-contain dark:brightness-200" />
            <div className="hidden sm:block text-sm font-medium text-gray-500 dark:text-gray-400 border-l border-gray-300 dark:border-gray-600 pl-3">
      ...
      {/* Hero Section */}
      <div className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden bg-gradient-to-br from-rosegold-900 to-lightpurple-900 text-white">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-rosegold-900/90"></div>
        <div className="relative z-10 container mx-auto px-6 text-center max-w-4xl">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-rosegold-100 to-lightpurple-100 drop-shadow-sm">
            {d.hero.title}
          </h1>
          
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 mt-12 text-lg text-rosegold-50/90 font-medium">
            <div className="flex items-center bg-white/5 px-4 py-2 rounded-lg backdrop-blur-sm">
              <Calendar className="w-5 h-5 mr-3 text-rosegold-300"/> 
              {d.hero.date}
            </div>
            <div className="flex items-center bg-white/5 px-4 py-2 rounded-lg backdrop-blur-sm">
              <Clock className="w-5 h-5 mr-3 text-rosegold-300"/> 
              {d.hero.time}
            </div>
            <div className="flex items-center bg-white/5 px-4 py-2 rounded-lg backdrop-blur-sm">
              <MapPin className="w-5 h-5 mr-3 text-rosegold-300"/> 
              {d.hero.location}
            </div>
          </div>
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-3 px-8 py-4 bg-white text-rosegold-900 hover:bg-rosegold-50 rounded-full font-bold shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300"
            >
            ...
            <a 
              ...
              key={lang}
              className="w-full sm:w-auto inline-flex items-center justify-center space-x-3 px-8 py-4 bg-rosegold-800/50 hover:bg-rosegold-700/50 border border-rosegold-400/30 text-white rounded-full font-bold backdrop-blur-sm shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300"
            >
      ...
      <div className="container mx-auto px-6 py-16 space-y-24 max-w-5xl">
        ...
        <section className="scroll-mt-24">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-rosegold-500 to-lightpurple-500 mx-auto rounded-full"></div>
            <p className="mt-6 text-xl text-rosegold-600 dark:text-rosegold-400 font-medium">{d.intro.subtitle}</p>
          </div>
        ...
        <section className="scroll-mt-24">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-rosegold-50 to-orange-50 dark:from-slate-800 dark:to-slate-800/80 rounded-3xl p-8 md:p-10 shadow-lg border border-rosegold-100 dark:border-slate-700">
              <div className="flex items-center space-x-4 mb-6">
                <div className="p-3 bg-rosegold-500 text-white rounded-2xl shadow-md">
            ...
            <div className="bg-gradient-to-br from-lightpurple-50 to-pink-50 dark:from-slate-800 dark:to-slate-800/80 rounded-3xl p-8 md:p-10 shadow-lg border border-lightpurple-100 dark:border-slate-700">
              <div className="flex items-center space-x-4 mb-6">
                <div className="p-3 bg-lightpurple-500 text-white rounded-2xl shadow-md">
            ...
            {conductors.map((c, idx) => (
              <Card key={idx} className="overflow-hidden hover:shadow-xl transition-shadow">
                <div className="grid md:grid-cols-3">
                  <div className="bg-gradient-to-br from-lightpurple-100 to-rosegold-100 dark:from-slate-800 dark:to-slate-700 p-8 flex flex-col items-center justify-center h-full space-y-4">
                    <img
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-lightpurple-700 dark:text-lightpurple-300 font-medium mb-4">{c.title}</p>
                      ...
                      <div className="flex flex-col space-y-3 w-full mt-4">
                        {c.experience && (
                          <div className="flex items-center text-sm px-4 py-2 rounded-lg bg-white/50 dark:bg-white/10 ring-1 ring-black/5 dark:ring-white/10 backdrop-blur-sm text-gray-700 dark:text-slate-300 w-full">
                            <User className="h-4 w-4 mr-2 text-lightpurple-600 dark:text-lightpurple-400 flex-shrink-0" />
                            <span className="text-left leading-tight">{c.experience}</span>
                          </div>
                        )}
                        {c.education && (
                          <div className="flex items-center text-sm px-4 py-2 rounded-lg bg-white/50 dark:bg-white/10 ring-1 ring-black/5 dark:ring-white/10 backdrop-blur-sm text-gray-700 dark:text-slate-300 w-full">
                            <Music className="h-4 w-4 mr-2 text-lightpurple-600 dark:text-lightpurple-400 flex-shrink-0" />
                          ...
                          <ul className="space-y-2">
                            {c.highlights.map((h, i) => (
                              <li key={i} className="flex items-start space-x-2">
                                <div className="w-2 h-2 bg-rosegold-500 rounded-full mt-2 flex-shrink-0"></div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        {c.achievements.map((a, i) => (
                          <li key={i} className="flex items-start space-x-2">
                            <div className="w-2 h-2 bg-lightpurple-500 rounded-full mt-2 flex-shrink-0"></div>
                            <span className="text-gray-600 dark:text-slate-300">{a}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
                    <div className="bg-gradient-to-r from-lightpurple-50 to-rosegold-50 dark:from-slate-800 dark:to-slate-700 rounded-lg p-4 md:p-6">
        ...
        <section className="scroll-mt-24">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 dark:border-slate-700">
            {/* First Half */}
            <div className="mb-8">
              <h3 className="text-xl md:text-2xl font-bold text-rosegold-800 dark:text-rosegold-300 mb-6 pb-2 border-b border-gray-200 dark:border-slate-700">{d.program.firstHalf.title}</h3>
                ...
                {d.program.firstHalf.items.map(item => (
                  <div key={item.no} className="flex flex-col sm:flex-row sm:items-center justify-between p-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors gap-3">
                    <div className="flex items-center space-x-4">
                      <span className="text-lg font-bold text-rosegold-500 w-8">{item.no}</span>
                      <div>
            ...
            {/* Second Half */}
            <div className="mb-12">
              <h3 className="text-xl md:text-2xl font-bold text-rosegold-800 dark:text-rosegold-300 mb-6 pb-2 border-b border-gray-200 dark:border-slate-700">{d.program.secondHalf.title}</h3>
              <div className="space-y-3">
            ...
            {d.talents.sections.map((section, i) => (
              <div key={i} className="bg-white dark:bg-slate-800 rounded-3xl overflow-hidden shadow-xl border border-gray-100 dark:border-slate-700 flex flex-col hover:shadow-2xl transition-shadow group">
                ...
                <div className="p-6 md:p-8 flex flex-col flex-grow items-center text-center">
                  <div className="w-16 h-16 bg-rosegold-100 dark:bg-slate-700 rounded-full flex items-center justify-center text-rosegold-600 dark:text-rosegold-400 transform -translate-y-12 md:-translate-y-14 shadow-lg border-4 border-white dark:border-slate-800 z-10">
        ...
        <section className="scroll-mt-24 pb-12">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 dark:border-slate-700 text-center mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-12 text-left">
              ...
              <div className="space-y-6">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white border-b-2 border-rosegold-500 pb-2 inline-block">{d.gratitude.acknowledgements.title}</h3>
              ...
              {/* EXCO & Teams */}
              <div className="space-y-6">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white border-b-2 border-lightpurple-500 pb-2 inline-block">{d.gratitude.exco.title}</h3>
                <div className="space-y-3">
          ...
          {/* Founder's Note */}
          <div className="bg-gradient-to-br from-slate-900 to-rosegold-900 rounded-3xl p-8 md:p-12 shadow-2xl text-white relative overflow-hidden">
      ...
      <div className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-50 flex flex-col items-center space-y-3">
        <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-lg p-2 rounded-full shadow-2xl border border-gray-200/50 dark:border-slate-700/50 flex flex-col space-y-2 items-center">
          <div className="flex flex-col items-center bg-slate-100/50 dark:bg-slate-900/50 rounded-full p-1 space-y-1">
            <button 
              onClick={() => setLang('zh')} 
              className={`w-10 h-10 flex items-center justify-center rounded-full text-xs font-bold transition-all ${lang==='zh'?'bg-white dark:bg-slate-700 text-rosegold-600 dark:text-rosegold-400 shadow-md scale-105':'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-white/50 dark:hover:bg-slate-700/50'}`}
              title="切换到中文"
            >
              中
            </button>
            ...
            <button 
              onClick={() => setLang('en')} 
              className={`w-10 h-10 flex items-center justify-center rounded-full text-xs font-bold transition-all ${lang==='en'?'bg-white dark:bg-slate-700 text-rosegold-600 dark:text-rosegold-400 shadow-md scale-105':'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-white/50 dark:hover:bg-slate-700/50'}`}
          ...
          <button
            ...
            className="w-12 h-12 mt-2 flex items-center justify-center rounded-full bg-gradient-to-tr from-rosegold-100 to-lightpurple-100 dark:from-slate-700 dark:to-slate-600 hover:from-rosegold-200 hover:to-lightpurple-200 dark:hover:from-slate-600 dark:hover:to-slate-500 transition-all shadow-md text-gray-700 dark:text-gray-200"
          >
